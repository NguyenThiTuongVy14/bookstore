...
if (isset($_POST['checkout'])) {
    if (isset($_SESSION['user_id'])) {
        ...
        foreach ($_SESSION['cart'] as $product_id => $quantity) {
            ...
            $stmt_order_details = $con->prepare("INSERT INTO order_details (order_id, product_id, quantity) 
                            ...
                            if ($result_count > 0) {
                                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="qty[<?php echo $product_id; ?>]" class="form-input w-50" value="<?php echo $quantity; ?>">
                                        </td>
                                        ...
                                        <td>
                                            <form action="" method="post">
                                                ...
                                                <input type="submit" value="Cập nhật giỏ hàng" class="btn bg-info px-3 py-1 border-0 mx-2 text-light" name="update_cart">
                                            </form>
                                        </td>
                                        <td>
                                            <form action="" method="post">
                                                ...
                                                <input type="hidden" name="product_id" value="<?php echo $product_id; ?>">
                                                <input type="submit" value="Xoá khỏi giỏ hàng" class="btn bg-danger text-light px-3 py-1 border-0 mx-2" name="remove_cart" >
                                            </form>
                                        </td>
                                    </tr>
                                    <?php
                                ...
                                foreach ($_SESSION['cart'] as $product_id => $quantity) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="submit" value="Xoá khỏi giỏ hàng" class="btn bg-danger text-light px-3 py-1 border-0 mx-2">
                                        </td>
                                    </tr>
                                    <?php
                                }
